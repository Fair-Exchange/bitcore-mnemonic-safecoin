...
var Bitcore_ = {
  ...
  safe: require('bitcore-lib-safecoin'),
  btcz: require('bitcore-lib-btcz'),
  btg: require('bitcore-lib-btg'),
  zcl: require('bitcore-lib-zcl'),
  rito: require('bitcore-lib-rito'),
  anon: require('bitcore-lib-anon'),
  zel: require('bitcore-lib-zel'),
  zen: require('bitcore-lib-zen'),
  rvn: require('bitcore-lib-rvn'),
 ...
 * @constructor
 */
var Mnemonic = function(data, wordlist, coin) {
  if (!(this instanceof Mnemonic)) {
    return new Mnemonic(data, wordlist, coin);
  }
  if (!coin || (coin !== 'safe' && coin !== 'btcz' && coin !== 'btg' && 
                coin !== 'btc' && coin !== 'bch' && coin !== 'ltc' && 
                coin !== 'rvn' && coin !== 'rito' && coin !== 'zel' && 
                coin !== 'zen' && coin !== 'zcl' && coin !== 'anon')) 
    throw new errors.InvalidCoin(coin);
  bitcore = Bitcore_[coin];
